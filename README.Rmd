...
taller_repro_SII <img src="figures/readme/compendium-sticker.png" align="right" style="float:right; height:120px;"/>
=========================================================
...
Launch the [`make.R`](https://github.com/VicenteRobinson/taller_repro_SII/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/VicenteRobinson/taller_repro_SII/blob/main/CONTRIBUTING.md).
