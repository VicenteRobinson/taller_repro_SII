...
# taller\_repro\_SII <img src="figures/readme/compendium-sticker.png" align="right" style="float:right; height:120px;"/>
...
-   [`DESCRIPTION`](https://github.com/VicenteRobinson/taller_repro_SII/tree/main/DESCRIPTION):
    contains project metadata (authors, date, dependencies, etc.)

-   [`make.R`](https://github.com/VicenteRobinson/taller_repro_SII/tree/main/make.R):
    main R script to run the entire project

-   [`R/`](https://github.com/VicenteRobinson/taller_repro_SII/tree/main/R):
...
Guidelines](https://github.com/VicenteRobinson/taller_repro_SII/blob/main/CONTRIBUTING.md).
